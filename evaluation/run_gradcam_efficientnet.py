...
def main():
    ...
    out_dir = Path("/workspace/gradcam_outputs/efficientnetb0_60k")
    ...
    # For EfficientNet-B0 the target layer is the last convolutional block
    target_layers = [model.features[-1]]

    transform = get_transform()
    df = pd.read_csv(test_csv)

    # Use same random state as ResNet for identical images
